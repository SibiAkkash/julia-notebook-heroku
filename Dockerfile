...
RUN julia --project=${HOME}/deployment_env -e "import Pkg; Pkg.instantiate(); Pkg.precompile()"

# The "default command" for this docker thing.
CMD ["julia", "--project=/home/pluto/deployment_env", "-e", "import PlutoSliderServer; PlutoSliderServer.run_directory(\".\"; SliderServer_port=1234 , SliderServer_host=\"0.0.0.0\")"]